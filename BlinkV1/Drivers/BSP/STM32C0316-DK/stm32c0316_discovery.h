/**
  ******************************************************************************
  * @file    stm32c0316_discovery.h
  * @author  MCD Application Team
  * @brief   This file contains definitions for STM32C0316_DK's LEDs,
  *          push-buttons hardware resources (MB1716).
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32C0316_DK_H
#define STM32C0316_DK_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32c0316_discovery_conf.h"
...
/** @defgroup STM32C0316_DK STM32C0316 DK
  * @{
  */

/** @defgroup STM32C0316_DK_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup STM32C0316_DK_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
typedef enum
{
...
/** @defgroup STM32C0316_DK_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  * @{
  */
/**
  * @brief  Define for STM32C0316_DK board
  */
#if !defined (USE_STM32C0316_DK)
#define USE_STM32C0316_DK
...
/** @defgroup STM32C0316_DK_LOW_LEVEL_LED LOW LEVEL LED
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32C0316_DK_LOW_LEVEL_BUTTON LOW LEVEL BUTTON
  * @{
  */
/* Button state */
...
#define BUTTON_USER_EXTI_LINE                 GPIO_PIN_4
/**
  * @}
  */

/** @defgroup STM32C0316_DK_LOW_LEVEL_COM LOW LEVEL COM
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32C0316_DK_LOW_LEVEL_JOYSTICK LOW LEVEL JOYSTICK
  * @{
  */
/* Joystick Pins definition */
#define JOY_KEY_NUMBER                     5U

#define JOY1_SEL_PIN                       GPIO_PIN_4
...
#define JOY1_SEL_EXTI_LINE                 GPIO_PIN_4
...
#define JOY1_DOWN_EXTI_LINE                GPIO_PIN_4
...
#define JOY1_LEFT_EXTI_LINE                GPIO_PIN_4

#define JOY1_RIGHT_PIN                     GPIO_PIN_4
...
#define JOY1_RIGHT_EXTI_LINE               GPIO_PIN_4

#define JOY1_UP_PIN                        GPIO_PIN_4
...
#define JOY1_UP_EXTI_LINE                  GPIO_PIN_4
...
/** @addtogroup STM32C0316_DK_LOW_LEVEL_Exported_Variables
  * @{
  */
...
/** @addtogroup STM32C0316_DK_LOW_LEVEL_Exported_Functions
  * @{
  */
