/**
  ******************************************************************************
  * @file    stm32c0116_discovery.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage Leds
  *          and joystick of STM32C0116-DK board (MB1684)
  ******************************************************************************
  * @attention
  *
...
/** @addtogroup STM32C0116-DK
  * @brief This file provides firmware functions to manage Leds and joystick
  *        available on STM32C0116-DK board from STMicroelectronics.
  * @{
  */

/** @addtogroup STM32C0116_DK_LOW_LEVEL
  * @{
  */

/** @defgroup STM32C0116_DK_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Types Definitions
  * @{
  */
...
/** @defgroup STM32C0116_DK_LOW_LEVEL_Private_FunctionPrototypes  LOW LEVEL Private Function Prototypes
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32C0116_DK_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Variables
  * @{
  */
...
/** @defgroup STM32C0116_DK_LOW_LEVEL_Private_Variables LOW LEVEL Private Variables
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32C0116_DK_Exported_Functions Exported Functions
  * @{
  */
/**
  * @brief  This method returns the STM32C0116_DK BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)STM32C0116_DK_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32C0116_DK_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32C0116_DK_BSP_BOARD_ID;
}
...
/** @defgroup STM32C0116_DK_LOW_LEVEL_Private_Functions LOW LEVEL Private Functions
  * @{
  */
/**
