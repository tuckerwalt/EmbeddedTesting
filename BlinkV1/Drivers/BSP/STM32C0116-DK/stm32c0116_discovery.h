...
/**
  * @brief STM32C0116_DK BSP Driver version number V1.1.1
  */
#define STM32C0116_DK_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define STM32C0116_DK_BSP_VERSION_SUB1   (uint32_t)(0x01) /*!< [23:16] sub1 version */
#define STM32C0116_DK_BSP_VERSION_SUB2   (uint32_t)(0x01) /*!< [15:8]  sub2 version */
